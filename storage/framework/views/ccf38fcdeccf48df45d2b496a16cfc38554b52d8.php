...
<html class="no-js" lang="">
	<head>
		...
		<link rel="stylesheet" href="<?php echo e(asset('barcode/other/css/normalize.css')); ?>">
		<!-- Main Css -->
		<link rel="stylesheet" href="<?php echo e(asset('barcode/css/bootstrap.min.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('barcode/css/font-awesome/css/font-awesome.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('barcode/css/plugin.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('barcode/css/main.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('barcode/other/css/animate.min.css')); ?>">


		<!-- Fontawesome CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('barcode/other/css/fontawesome-all.min.css')); ?>">
		<!-- Flaticon CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('barcode/other/fonts/flaticon.css')); ?>">
		<!-- Custom Css -->
		<link rel="stylesheet" href="<?php echo e(asset('barcode/other/style.css')); ?>">
		<!-- Modernizr Js -->
		<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css" />
		<script src="<?php echo e(asset('barcode/other/js/jquery-3.3.1.min.js')); ?>"></script>
		<script src="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js"></script>
		<script src="<?php echo e(asset('barcode/other/js/modernizr-3.6.0.min.js')); ?>"></script>
...
.well-block .dish-price { font-size: 26px; color: #e03c23; font-weight: 500; font-family: 'Zilla Slab', serif; position: inherit; }			
	...
	<body>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center">
							<img  class="" src="<?php echo e(asset('images/'.$model->logo)); ?>" alt="">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="page-header wow fadeInDown mt-0">
								<h3 class="h3"><?php echo e($model->name); ?>
					...
					<div class="row">
						<div class="col-md-8"><form style="display: inline-flex;" id="front_food_filter">
							<?php echo csrf_field(); ?>
								<?php echo e(session()->put('rest_id', $model->id)); ?>

								<input type="hidden" value="<?php echo e(session()->get('rest_id')); ?>" name="id" id="comn_id">
								...
								<div class="row">
									<div class="col-lg-6">
										...
										<ul class="search-items">
											<?php $__currentLoopData = $categoried; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $split): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if(!empty($split['subcat_withmenu'])): ?>
											<li>
												<div class="checkbox checkbox-primary">
													<input id="checkboxsubcat<?php echo e($split['id']); ?>" type="checkbox" value="<?php echo e(ucfirst($split['id'])); ?>" name="subactegory_filter[]">
													<label for="checkboxsubcat<?php echo e($split['id']); ?>"><?php echo e(ucfirst($split['dish_category'])); ?></label>
												</div>
											</li>
											<?php else: ?>
											<?php endif; ?>
									...
									<div class="col-lg-6">
										...
										<ul class="search-items">
											<li>
												<div class="checkbox checkbox-primary">
													<input id="checkboxtypes<?php echo e($model->id); ?>" type="checkbox" name="food_type[]" value="1">
													<label for="checkboxtypes<?php echo e($model->id); ?>">Veg</label>
												</div>
											</li>
											<li>
												<div class="checkbox checkbox-primary">
													<input id="checkboxs<?php echo e($model->id); ?>" type="checkbox" name="food_type[]" value="2">
													<label for="checkboxs<?php echo e($model->id); ?>">Non Veg</label>
												</div>
											</li>
										</ul>
									</div>
								...
								<div class="row">
									<div class="col-lg-6">
										...
										<ul class="search-items">
											<li>
												<div class="checkbox checkbox-primary">
													<input id="checkboxsel<?php echo e($model->id); ?>" type="checkbox" value="1" name="best_seller">
													<label for="checkboxsel<?php echo e($model->id); ?>">Best seller</label>
												</div>
											</li>
										</ul>
									</div>
									<div class="col-lg-6">
										...
										<ul class="search-items">
											<li>
												<div class="checkbox checkbox-primary">
													<input id="checkboxt<?php echo e($model->id); ?>" type="checkbox" value="1" name="chef">
													<label for="checkboxt<?php echo e($model->id); ?>">Today chef</label>
												</div>
											</li>
										</ul>
									</div>
        ...
        <?php echo $__env->make('layouts.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			...
			<script src="<?php echo e(asset('barcode/other/js/popper.min.js')); ?>"></script>
			<!-- Bootstrap Js -->
			<script src="<?php echo e(asset('barcode/other/js/bootstrap.min.js')); ?>"></script>
			<!-- Plugins Js -->
			<script src="<?php echo e(asset('barcode/other/js/plugins.js')); ?>"></script>
			<!-- Smoothscroll Js -->
			<script src="<?php echo e(asset('barcode/other/js/smoothscroll.min.js')); ?>"></script>
			<!-- Custom Js -->
			<script src="<?php echo e(asset('barcode/other/js/main.js')); ?>"></script>
			...
			$(document).ready(function() {
			    ...
			    $('input[name="content"]').on('keyup', function(e) {
			        $.ajax({
			            type: 'post',
			            url: "<?php echo e(route('menus.list.filter')); ?>",
...
<?php /**PATH E:\xampp\htdocs\restaurant-manage\resources\views/barcode.blade.php ENDPATH**/ ?>