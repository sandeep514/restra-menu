...
<div class="app-main__outer">
    ...
    <?php endif; ?> 
        <form class="" method="post" action="<?php echo e(route('admin.resturant.save')); ?>" enctype="multipart/form-data">
               <?php echo csrf_field(); ?>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <select  id="country-dd" class="form-control" name="country">
                            ...
                            <option value="<?php echo e($data->id); ?>" <?php echo e($data->id ==' 101'? 'selected' : ''); ?>>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\restaurant-manage\resources\views/admin/create.blade.php ENDPATH**/ ?>